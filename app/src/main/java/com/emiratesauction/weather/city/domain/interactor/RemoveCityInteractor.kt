 ...
 *  ->
 */
class RemoveCityInteractor(private val mWeatherRepository: WeatherRepository) :
    Interactor<City, Flow<Boolean>> {
    override fun execute(params: City): Flow<Boolean> = mWeatherRepository.removeCity(params)
}