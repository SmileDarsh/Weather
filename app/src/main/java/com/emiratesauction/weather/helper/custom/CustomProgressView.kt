package com.emiratesauction.weather.helper.custom
...
import kotlinx.android.synthetic.main.custom_progress_layout.view.*
...
class CustomProgressView : CardView {
    ...
    private fun init(attrs: AttributeSet?) {
        val v = View.inflate(context, R.layout.custom_progress_layout, this)
    ...
    private fun showInternetData() {
        ...
        mIvProgress.setImageResource(R.drawable.ic_wifi_off)
    }
